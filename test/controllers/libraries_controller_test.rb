...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { address: @library.address, librarian_name: @library.librarian_name, name: @library.name }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { address: @library.address, librarian_name: @library.librarian_name, name: @library.name }
    assert_redirected_to library_path(assigns(:library))
  end
